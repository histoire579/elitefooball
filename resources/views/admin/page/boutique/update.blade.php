...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('administration.boutique.edit',$boutique->id)}}" enctype="multipart/form-data">
                    @csrf
                   
                    <div class="form-group row">
                        <label for="lieu" class="col-md-2 col-form-label">Lieu</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="lieu"  id="lieu" value="{{$boutique->lieu}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="horaire"  id="horaire" value="{{$boutique->horaire}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="horaire_en"  id="horaire_en" value="{{$boutique->horaire_en}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="/administration/boutique" type="button" class="btn btn-outline-danger waves-effect waves-light mt-3"> Annuler</a>
                        </div>
                    </div>
