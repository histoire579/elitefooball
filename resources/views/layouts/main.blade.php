...
<body>
	<div class="content-wrapper">
				...
				<div class="flex-lg-row align-items-center container flex-nowrap">
					...
					<div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
						<div class="offcanvas-header d-lg-none">
							<h3 class="fs-30 mb-0 text-white">Sandbox</h3>
									...
									<ul class="dropdown-menu mega-menu mega-menu-dark mega-menu-img">
										<li class="mega-menu-content">
											<ul class="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-6 gy-lg-4 list-unstyled">
												...
												<li class="col"><a class="dropdown-item" href="{{ url('/elite1/classement') }}">

														<span>Classements</span>
													</a>
												</li>
												<li class="col"><a class="dropdown-item" href="{{ url('/elite1/club') }}">
									...
									<ul class="dropdown-menu mega-menu mega-menu-dark mega-menu-img">
										<li class="mega-menu-content">
											<ul class="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-6 gy-lg-4 list-unstyled">
												...
												<li class="col"><a class="dropdown-item" href="{{ url('/elite2/classement') }}">

														<span>Classement</span>
													</a>
												</li>
												<li class="col"><a class="dropdown-item" href="{{ url('/elite2/club') }}">
		...
		<footer class="bg-dark text-inverse">
			<div class="py-13 py-md-15 container">
				<div class="row gy-6 gy-lg-0">
					<div class="col-lg-4">
						<div class="widget">
							<img class="mb-4" src="dist/assets/img/logo-light.png" srcset="distassets/img/logo-light@2x.png 2x"
								alt="" />
