										...
										<div class="row gy-3 gx-xl-8">
											<div class="card table-responsive">
												...
												<table class="table table-striped">
													<tbody>
														<tr>
															<td><a href="{{ route('detail_calend_result_two', $calendier->id) }}">{{ $calendier->club1->nom }} <img src="{{ asset($calendier->club1->logo) }}" style="height: 50px; width: 50px;" alt=""> <strong>{{ $calendier->heure }}</strong> <img src="{{ asset($calendier->club2->logo) }}" style="height: 50px; width: 50px;" alt=""> {{ $calendier->club2->nom }}</a></td>
										...
										<div class="row gy-3 gx-xl-8">
											<div class="card table-responsive">
												...
												<table class="table table-striped">
													<tbody>
														<tr>
															<td><a href="{{ route('detail_calend_result_two', $resultat->id) }}">{{ $resultat->club1->nom }} <img src="{{ asset($resultat->club1->logo) }}" style="height: 50px; width: 50px;" alt=""> <strong> {{ $resultat->nbre_but_club1 }} -- {{ $resultat->nbre_but_club2 }} </strong> <img src="{{ asset($resultat->club2->logo) }}" style="height: 50px; width: 50px;" alt=""> {{ $resultat->club2->nom }}</a></td>
